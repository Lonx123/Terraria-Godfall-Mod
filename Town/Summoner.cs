...
namespace Godfall.Town          //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    ...
    public class Summoner : ModNPC
    {
        ...
        {
            button = "Buy Relics";   //this defines the buy button name
        }
        ...
        public override void SetupShop(Chest shop, ref int nextSlot)       //Allows you to add items to this town NPC's shop. Add an item by setting the defaults of shop.item[nextSlot] then incrementing nextSlot.
        {
            ...
            nextSlot++;
			shop.item[nextSlot].SetDefaults(mod.ItemType("Blizzard"));  //this is an example of how to add a modded item
            nextSlot++;
			shop.item[nextSlot].SetDefaults(mod.ItemType("Bone"));  //this is an example of how to add a modded item
            nextSlot++;
            shop.item[nextSlot].SetDefaults(mod.ItemType("GodfallBar"));  //this is an example of how to add a modded item
            nextSlot++;
			shop.item[nextSlot].SetDefaults(mod.ItemType("Cloud"));  //this is an example of how to add a modded item
            nextSlot++;
			shop.item[nextSlot].SetDefaults(mod.ItemType("GodfallSummon"));  //this is an example of how to add a modded item
            nextSlot++;
			shop.item[nextSlot].SetDefaults(mod.ItemType("Mask"));  //this is an example of how to add a modded item
            nextSlot++;
			shop.item[nextSlot].SetDefaults(mod.ItemType("Spirit"));  //this is an example of how to add a modded item
            nextSlot++;
			shop.item[nextSlot].SetDefaults(mod.ItemType("Summon"));  //this is an example of how to add a modded item
            nextSlot++;
        }
        ...
        public override string GetChat()       //Allows you to give this town NPC a chat message when a player talks to it.
        {
            ...
            switch (Main.rand.Next(4))    //this are the messages when you talk to the npc
            {
                ...
                case 1:
                    return "I sell relics of the golden age...";
                case 2:
                    return "I like this house. It's very... modern!";
                case 3:
                    return "<I'm blue dabu di dabu dai>....OH HELLO THERE..";
                default:
                    return "You will not find anything else like what I have to offer anywhere...";
        ...
        {
            scale = 1f;
            item = Main.itemTexture[mod.ItemType("LunarEdge")]; //this defines the item that this npc will use
            itemSize = 56;
        }
