...
{
	public class SuperGood : ModItem
	{
		public override void SetStaticDefaults() {
		    DisplayName.SetDefault("SuperGoodAdvice");
			Tooltip.SetDefault("This weapon is full of it");
		}
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(mod.ItemType("HellBar"), 20);
			recipe.AddIngredient(mod.ItemType("Engram"), 1);
