...
namespace Godfall.Endgame
{
    public class Death : ModItem
    {
	      ...
	      public override void SetStaticDefaults()
        {
			...
			Tooltip.SetDefault("It's as epic as it sounds.");
			item.value = 5000000;
        }
        public override void SetDefaults()
        {
            //the name displayed when hovering over the Weapon ingame.
            item.damage = 750;  //The damage stat for the Weapon.
            ...
            item.mana = 10; //How mutch mana this weapon use
            ...
            item.value = Item.sellPrice(10, 0, 0, 0);//  How much the item is worth, in copper coins, when you sell it to a merchant. It costs 1/5th of this to buy it back from them. An easy way to remember the value is platinum, gold, silver, copper or PPGGSSCC (so this item price is 3gold)
        }
    }
}