...
{
    public class Sec : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("?????");
            Tooltip.SetDefault("Summons a secret boss...");
        }
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            // Does NPC Exist
            bool alreadySpawned = NPC.AnyNPCs(mod.NPCType("Secret"));
        ...
        {
            NPC.SpawnOnPlayer(player.whoAmI, mod.NPCType("Secret")); // Spawn the boss within a range of the player. 
