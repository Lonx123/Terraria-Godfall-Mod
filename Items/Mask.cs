...
{
    public class Mask : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Mysterious Mask...");
            Tooltip.SetDefault("Whose could it be?");
        }
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            // Does NPC Exist
            bool alreadySpawned = NPC.AnyNPCs(mod.NPCType("NewBoss"));
        ...
        {
            NPC.SpawnOnPlayer(player.whoAmI, mod.NPCType("NewBoss")); // Spawn the boss within a range of the player. 
		...
		public override void AddRecipes()
        {
			...
			r.AddIngredient(null, "HellBar", 5);
