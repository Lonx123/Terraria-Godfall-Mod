...
{
    public class GodfallSummon : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Heavenly Eye");
            Tooltip.SetDefault("Summons the Godfall Gazer");
        }
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            // Does NPC Exist
            bool alreadySpawned = NPC.AnyNPCs(mod.NPCType("GodfallGazer"));
        ...
        {
            NPC.SpawnOnPlayer(player.whoAmI, mod.NPCType("GodfallGazer")); // Spawn the boss within a range of the player. 
		...
		public override void AddRecipes()
        {
			...
			r.AddIngredient(ItemID.SuspiciousLookingEye, 1);
