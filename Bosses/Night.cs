...
namespace Godfall.Bosses
{
	...
	public class Night : ModNPC
	{
		...
		public override void AI()
		{
			...
			{
				NPC.NewNPC((int)npc.position.X - 50, (int)npc.position.Y, NPCID.Corruptor);
				NPC.NewNPC((int)npc.position.X + 50, (int)npc.position.Y, NPCID.Corruptor);
				NPC.NewNPC((int)npc.position.X + 50, (int)npc.position.Y, NPCID.Corruptor);
			}
		...
		public override void NPCLoot()
        {
			...
			Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("HellBar"), Main.rand.Next(1, 1));
			Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("HellBar"), Main.rand.Next(1, 1));
			Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("Night"), Main.rand.Next(1, 1));
        }
	}
}