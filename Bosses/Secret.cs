...
namespace Godfall.Bosses
{
	...
	public class Secret : ModNPC
	{
		...
		public override void NPCLoot()
        {
			...
			Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("HellBar"), Main.rand.Next(1, 1));
			Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("HellBar"), Main.rand.Next(1, 1));
			Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("Bape"), Main.rand.Next(1, 1));
			Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("Fish"), Main.rand.Next(1, 1));
        }
	}
}