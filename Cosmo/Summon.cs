...
namespace Godfall.Cosmo
{
    public class Summon : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("Looks like some kind of reinforcements call...\n" +
            "Summons the Cosmic Invaders!");
        }
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            // Does NPC Exist
            bool alreadySpawned = NPC.AnyNPCs(mod.NPCType("Cosmic"));
        ...
        {
            NPC.SpawnOnPlayer(player.whoAmI, mod.NPCType("Cosmic")); // Spawn the boss within a range of the player. 
